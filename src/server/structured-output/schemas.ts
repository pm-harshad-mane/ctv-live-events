...
const liveStateSchema = objectSchema(
  {
    ...
    special_state: objectSchema(
      {
        ...
        is_postponed: { type: "boolean" },
        is_cancelled: { type: "boolean" },
        is_suspended: { type: "boolean" },
        pause_reason: nullable(stringSchema),
        status_reason: nullable(stringSchema)
      },
      [
        "is_timeout",
        "is_under_review",
    ...
    watchability: objectSchema(
      {
        current_score: numberSchema,
        tension_score: numberSchema,
        scoring_imminence_score: numberSchema,
        swing_potential_score: numberSchema,
        state_clarity_score: numberSchema,
        evidence_strength_score: numberSchema
      },
      [
        "current_score",
        "tension_score",
    ...
    cross_phase_scores: objectSchema(
      {
        stakes_score: numberSchema,
        star_power_score: numberSchema,
        upset_potential_score: numberSchema,
        narrative_strength_score: numberSchema
      },
      [
        "stakes_score",
        "star_power_score",
    ...
    upcoming_intelligence: objectSchema(
      {
        ...
        audience_signals: objectSchema(
          {
            audience_interest_score: numberSchema,
            stakes_score: numberSchema,
            star_power_score: numberSchema,
            volatility_score: numberSchema,
            upset_potential_score: numberSchema,
            narrative_strength_score: numberSchema
          },
          [
...
export const openAiSchemas = structuredOutputSchemas;
